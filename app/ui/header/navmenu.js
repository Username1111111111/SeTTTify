        ...
        <nav className="row align-items-center justify-content-center w-100 ps-2">
            ...
            <ul className="col list-unstyled d-flex justify-content-around justify-content-md-start mb-0 w-100">
                <li className="nav-item me-1 me-md-3 fs-6 py-2">
                    <Link href="/" className={`${styles.magicHover} nav-link fs-5`}>
                        Home
                    </Link>
                </li>
                <li className="nav-item me-1 me-md-3 fs-6 py-2">
                    <Link href="/collections" className={`${styles.magicHover} nav-link fs-5`}>
                        Collections
                    </Link>
                </li>
                <li className="nav-item me-1 me-md-3 fs-6 py-2">
                    <Link href="/users" className={`${styles.magicHover} nav-link fs-5`}>
                        Users
                    </Link>
                </li>
            </ul>
